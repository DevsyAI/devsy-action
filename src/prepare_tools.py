...
def main() -> None:
    ...
    set_github_output("disallowed_tools", args.disallowed_tools)
    ...
    if args.disallowed_tools:
        disallowed_count = len([t for t in args.disallowed_tools.split(",") if t.strip()])
        print(f"🚫 Disallowed tools: {disallowed_count} tools")
